...
where ld.isFakeEmail = 0
  ...
  and rd.work_exp between 4 and 6
 ...
 ) tt  where tt.cand_name is not null INTO OUTFILE '/tmp/promotional_data_F2_11Jun2016.txt' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'; 
