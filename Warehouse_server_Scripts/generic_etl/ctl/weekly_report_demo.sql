...
load data local infile 'ALL_Weekely_Demo_REPActiveClient_Details_NEW_changed.txt' into table  weekly_report_stage_1 fields terminated by ',' enclosed by '"' lines terminated by '\n';
...
load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_paid_Database_service.txt' into table  weekly_report_dbservices fields terminated by ',' enclosed by '"' lines terminated by '\n';

load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_paid_Job_posting_service.txt' into table  weekly_report_jobservices fields terminated by ',' enclosed by '"' lines terminated by '\n';

load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_paid_Visibility_service.txt' into table  weekly_report_visibilityservices fields terminated by ',' enclosed by '"' lines terminated by '\n';

load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_paid_Other_service.txt' into table  weekly_report_otherservices fields terminated by ',' enclosed by '"' lines terminated by '\n';
...
load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_trial_Database_service.txt' into table  weekly_report_dbservices fields terminated by ',' enclosed by '"' lines terminated by '\n';

load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_trial_Job_posting_service.txt' into table  weekly_report_jobservices fields terminated by ',' enclosed by '"' lines terminated by '\n';

load data local infile 'ALL_Weekely_Demo_REPActiveClient_Active_trial_Visibility_service.txt' into table  weekly_report_visibilityservices fields terminated by ',' enclosed by '"' lines terminated by '\n';
