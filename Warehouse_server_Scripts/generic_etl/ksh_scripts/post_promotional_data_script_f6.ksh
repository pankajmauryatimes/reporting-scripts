...
rm -f $HOME/generic_etl/wip/promotional_data_F6.txt
cp /tmp/promotional_data_F6_${ddate}.txt $HOME/generic_etl/wip/promotional_data_F6.txt


ftp_dir=/home/datareq/generic_etl/wip

ftp_file=$HOME/generic_etl/wip/promotional_data_F6.ftp
...
echo "pwd" >> $ftp_file
echo "put promotional_data_F6.txt" >> $ftp_file
echo "quit" >> $ftp_file
echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
printf "for F6 " >> $HOME/generic_etl/logs/dummy.txt
