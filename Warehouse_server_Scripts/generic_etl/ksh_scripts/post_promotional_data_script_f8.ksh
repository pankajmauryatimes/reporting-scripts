...
rm -f $HOME/generic_etl/wip/promotional_data_F8.txt
cp /tmp/promotional_data_F8_${ddate}.txt $HOME/generic_etl/wip/promotional_data_F8.txt
mv $HOME/generic_etl/wip/promotional_F8_AD_ID.csv $HOME/generic_etl/data_archive/promotional_F8_AD_ID_${ddate}.csv

ftp_dir=/home/datareq/generic_etl/wip

ftp_file=$HOME/generic_etl/wip/promotional_data_F8.ftp
...
echo "pwd" >> $ftp_file
echo "put promotional_data_F8.txt" >> $ftp_file
echo "quit" >> $ftp_file
echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
printf "for F8 " >> $HOME/generic_etl/logs/dummy.txt
