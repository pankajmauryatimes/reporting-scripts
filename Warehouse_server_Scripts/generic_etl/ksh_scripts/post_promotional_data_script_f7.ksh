...
rm -f $HOME/generic_etl/wip/promotional_data_F7.txt

cp /tmp/promotional_data_F7_${ddate}.txt $HOME/generic_etl/wip/promotional_data_F7.txt

ftp_file=$HOME/generic_etl/wip/promotional_data_F7.ftp
...
echo "pwd" >> $ftp_file
echo "put promotional_data_F7.txt" >> $ftp_file
echo "quit" >> $ftp_file
echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
printf "for F7 " >> $HOME/generic_etl/logs/dummy.txt
