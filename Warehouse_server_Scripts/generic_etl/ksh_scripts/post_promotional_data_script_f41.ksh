...
rm -f $HOME/generic_etl/wip/promotional_data_F41.txt

cp /tmp/promotional_data_F41_${ddate}.txt $HOME/generic_etl/wip/promotional_data_F41.txt

ftp_file=$HOME/generic_etl/wip/promotional_data_F41.ftp
...
echo "pwd" >> $ftp_file
echo "put promotional_data_F41.txt" >> $ftp_file
echo "quit" >> $ftp_file
echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
printf "for F41 " >> $HOME/generic_etl/logs/dummy.txt
