...
where ld.isFakeEmail = 0
  ...
  and rd.work_exp between 10 and 99
 ...
 ) tt  where tt.cand_name is not null INTO OUTFILE '/tmp/promotional_data_F41_${ddate}.txt' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\\n';"> $HOME/generic_etl/sql_scripts/promotional_data_script_f41.sql
