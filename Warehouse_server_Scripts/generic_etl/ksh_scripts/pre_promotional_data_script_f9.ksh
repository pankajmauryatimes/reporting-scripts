...
where ld.isFakeEmail = 0
 ...
 ) tt  where tt.cand_name is not null INTO OUTFILE '/tmp/promotional_data_F9_${ddate}.txt' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\\n'; " > $HOME/generic_etl/sql_scripts/promotional_data_script_f9.sql
