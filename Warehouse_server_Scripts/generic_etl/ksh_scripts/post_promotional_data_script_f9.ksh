...
rm -f $HOME/generic_etl/wip/promotional_data_F9.txt
cp /tmp/promotional_data_F9_${ddate}.txt $HOME/generic_etl/wip/promotional_data_F9.txt


ftp_dir=/home/datareq/generic_etl/wip

ftp_file=$HOME/generic_etl/wip/promotional_data_F9.ftp
...
echo "pwd" >> $ftp_file
echo "put promotional_data_F9.txt" >> $ftp_file
echo "quit" >> $ftp_file
echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
printf "for F9 " >> $HOME/generic_etl/logs/dummy.txt
