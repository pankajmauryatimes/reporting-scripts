...
echo "get delhi_native_jobs_211014.csv" >> $ftp_file
echo "get bangalore_native_jobs_211014.csv" >> $ftp_file
...
cat native_jobs_H.txt delhi_native_jobs_211014.csv > delhi_native_jobs_${f_date}.csv
cat native_jobs_H.txt bangalore_native_jobs_211014.csv > bangalore_native_jobs_${f_date}.csv
...
zip native_jobs_${f_date}.zip delhi_native_jobs_${f_date}.csv bangalore_native_jobs_${f_date}.csv chennai_native_jobs_${f_date}.csv coimbatore_native_jobs_${f_date}.csv
