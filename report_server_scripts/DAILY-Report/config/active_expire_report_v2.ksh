...
then
     ...
     echo "pwd" >> $ftp_file
     echo "get expire_report_v2_${today}.csv" >> $ftp_file
     echo "get active_report_v2_${today}.csv" >> $ftp_file
     echo "quit" >> $ftp_file
     echo "EOF" >> $ftp_file
#execute FTP script
chmod 755 ${ftp_file}
...
$email active_report_v2_${today} "anupam.gupta2@timesgroup.com" "sanjay.biswas@timesgroup.com,,gaurav.kumar2@timesgroup.com" "$cur_proc_name -Active Client" "$txt_body"
...
$email expire_report_v2_${today} "anupam.gupta2@timesgroup.com" "sanjay.biswas@timesgroup.com,gaurav.kumar2@timsegroup.com" "$cur_proc_name -Expire Client" "$txt_body"
